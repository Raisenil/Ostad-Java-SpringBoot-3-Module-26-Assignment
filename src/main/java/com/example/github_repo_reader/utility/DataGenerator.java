package com.example.github_repo_reader.utility;

import static com.example.github_repo_reader.repo_reader.RepoReader.REPO_FOLDER;
...
import com.example.github_repo_reader.repo_reader.model.ReadmeContent;
import com.example.github_repo_reader.repo_reader.model.ReadmeContentWrapper;
...
public class DataGenerator {
    ...
    public Pair<Pair<List<Topic>,List<SubTopic>>, List<Blog>> generateData(){
        ...
        for(String strFolder : folders){
            ...
            final Topic topic = new Topic( topicName, 0, strFolder, topicSerial );
            topicSerial++;
            topics.add(topic);
