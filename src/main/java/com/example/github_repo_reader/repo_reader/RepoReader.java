package com.example.github_repo_reader.repo_reader;
...
public class RepoReader {
    ...
    private boolean cloneRepo(String accessToken){
        ...
        if (accessToken == null || accessToken.trim().isEmpty() || "NOT_SET".equalsIgnoreCase(accessToken)) {
            repoUrl = "https://github.com/" + REPO_OWNER + "/" + REPO_NAME;
        } else {
            repoUrl = "https://" + accessToken + "@github.com/" + REPO_OWNER + "/" + REPO_NAME;
        }
